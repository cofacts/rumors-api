  ...
  it('returns new AI response', async () => {
    ...
    expect(loadingAIReply).toMatchInlineSnapshot(`
      Object {
        ...
        "request": "{\\"model\\":\\"gpt-3.5-turbo\\",\\"messages\\":[{\\"role\\":\\"system\\",\\"content\\":\\"現在是2020年10月。你是協助讀者進行媒體識讀的小幫手。你說話時總是使用台灣繁體中文。有讀者傳了一則網路訊息給你。這則訊息2020年1月就在網路上流傳。\\"},{\\"role\\":\\"user\\",\\"content\\":\\"我優秀的斐陶斐大姐是中央銀行退休，她剛看了一下，上網登記除要身份証號碼，還要健保卡號，健保卡號很少會要求提供，被洩漏機會相對少，但這次登記要一次完整的登入雙證件的號碼有點讓人擔憂，連同銀行帳號一併洩漏後果可怕！ \\"},{\\"role\\":\\"user\\",\\"content\\":\\"請問作為閱聽人，我應該注意這則訊息的哪些地方呢？\\\\n請節錄訊息中需要特別留意的地方，說明為何閱聽人需要注意它，謝謝。\\"}],\\"user\\":\\"test\\",\\"temperature\\":0}",
        "status": "LOADING",
        "type": "AI_REPLY",
        "userId": "test",
      }
