...
export default new GraphQLEnumType({
  ...
  values: {
    RUMOR: {
      value: 'RUMOR',
      description: 'The replier thinks that the article contains false information.',
    },
    NOT_RUMOR: {
      value: 'NOT_RUMOR',
      description: 'The replier thinks that the articles contains no false information.',
    },
    NOT_ARTICLE: {
      value: 'NOT_ARTICLE',
